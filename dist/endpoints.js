...
exports.endPoints = {
    ...
    STUDIOS: {
        "GET /api/studios": {
            description: "Serves an object containing an array of all studios, the current page, number of items per page, and total number of pages. Serves back default 10 per page sorted by studio_id asc",
        ...
        "PATCH /api/studios/:studio_id": {
            description: "acceps a body of inc_votes and updates the votes on each studio",
    ...
    CARTOONS: {
        "GET /api/cartoons": {
            description: "Serves an object containing an array of all cartoons, the current page, number of items per page, and total number of pages. Serves back default 10 per page sorted by studio_id asc",
            queries: ["sort_by", "order_by", "limit", "page"],
            exampleResponse: {
                cartoons: [
                    {
        ...
        "POST /api/cartoons": {
            description: "Accepts a body of a new cartoon and returns the new cartoon",
            exampleRequest: {
    ...
    CHARACTERS: {
        "GET /api/characters": {
            description: "Serves an object containing an array of all characters, the current page, number of items per page, and total number of pages. Serves back default 10 per page sorted by character_id asc",
            queries: ["sort_by", "order_by", "limit", "page"],
            exampleResponse: {
                characters: [
                    {
    ...
    COMMENTS: {
        ...
        "GET /api/comments": {
            description: "Serves an object containing an array of all comments, the current page, number of items per page, and total number of pages. Serves back default 10 per page sorted by comment_id asc",
            queries: ["sort_by", "order_by", "limit", "page"],
            exampleResponse: {
                comments: [
                    {
        ...
        "POST /api/comments": {
            description: "Accepts a body and returns a new comment. author/cartoon_id must be valid",
            exampleRequest: {
                cartoon_id: 1,
